...
/* BM_ADD(readprop) */
#define BM_ADD(r) {\
        .v = (const char *[]){ "bm", winid, r, NULL } \
}

/* DOWNLOAD(URI, referer) */
#define DOWNLOAD(u, r) { \
        .v = (const char *[]){ "st", "-e", "/bin/sh", "-c",\
             "echo >~/log.txt curl -g -L -J -O -A \"$1\" -b \"$2\" -c \"$2\" -e \"$3\" \"$4\";" \
...
static SiteSpecific styles[] = {
	...
	{ "startpage.com/do/search", "startpage.css" },
	{ "google.com/search",       "google.css" },
	{ "search.brave.com/search", "brave.css" },
	{ "gibiru.com/results.html", "gibiru.css" },
	{ "search.disroot.org", "disroot.css" },
	{ "lichess.org",       "default.css" },
	{ "voidlinux.org",     "default.css" },
	{ "archlinux.org",     "default.css" },
	{ "git-scm.com",       "default.css" },
	{ "tree-sitter.github.io", "default.css" },
	{ ".*",               "wildcard.css" },
...
static Key keys[] = {
	...
	{ MODKEY,                GDK_KEY_d,      scrollv,    { .i = +95 } },
	{ MODKEY,                GDK_KEY_u,      scrollv,    { .i = -95 } },
